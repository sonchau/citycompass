      ...
      <div style={{ display: "flex" }}>
        <div style={{ flex: "0 0 70%" }}>
          ...
          <p>
            ...
            National Park, West Boundary Track, Horswood Road and Boundary Road
            in the north, Cardinia Creek. 25% McCormacks Road, Pound Road,
            Tooradin Station Road, Hardys Road and Dalmore Road in the east, the
            Western Port coastline and South Boundary Road East in the south,
            and Western Port Highway, South Gippsland Highway, South Gippsland
            Freeway, Princes Highway, Claredale Road and the Dandenong Creek in
            the west. Primary production Parkland Geografia visual treatment |
            Version 1.2 | May 2020 The City of Casey's boundaries are Police
            Road, Churchill National Park, West Boundary Residential Track,
            Horswood Road and Boundary Road in the north, Cardinia Creek.
          </p>
        </div>
        <div>
          <h2>Land use</h2>
